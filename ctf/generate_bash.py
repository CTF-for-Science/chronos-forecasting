...
bash_template_0 = \
"""\
repo="/home/alexey/Git/CTF-for-Science/models/chronos-forecasting"
...
bash_template_1 = \
"""\
python -u $repo/ctf/forecast_ctf_os.py --dataset "{dataset}" --pair_id "{pair_id}" --recon_ctx "{recon_ctx}" --validation "{validation}" --identifier "{identifier}" --device cuda:0
